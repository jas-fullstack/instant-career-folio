        ...
        <div className="max-w-6xl mx-auto">
            ...
            {highlights.map((highlight, index) => {
              ...
              return (
                <AnimatedSection 
                  ...
                  delay={index * 150}
                >
                  <Card className="card-animated text-center p-6 card-hover">
                    <CardContent className="pt-6">
                      <div className="w-16 h-16 bg-gradient-primary rounded-full flex items-center justify-center mx-auto mb-4 hover-scale">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {skillGroup.items.map((skill, skillIndex) => (
                          <Badge 
                            key={skillIndex} 
                            variant="secondary" 
                            className="px-3 py-1 hover-scale"
                          >
                            {skill}
                          </Badge>
                        ))}
            ...
            <AnimatedSection animation="slide-in-right" delay={500}>
              <Card className="card-animated card-hover">
